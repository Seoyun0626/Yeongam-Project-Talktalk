...
class ThirdWeekMissionPage extends StatelessWidget {
  const ThirdWeekMissionPage({Key? key, required this.hasParticipated})
      : super(key: key);
