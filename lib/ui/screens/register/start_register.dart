                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: TextButton(
                        ...
                        child: const TextCustom(text: '개인 회원가입', color: Colors.white, fontSize: 20),
                        onPressed: () => Navigator.push(context, routeSlide(page: const userTypePage())),
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: TextButton(
                        ...
                        child: const TextCustom(text: '카카오톡 회원가입', color: Colors.black, fontSize: 20),
